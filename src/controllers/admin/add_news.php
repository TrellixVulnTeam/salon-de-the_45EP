...
if (!empty($_POST)) {
    ...
    try {
        ...
        $target_dir = PUBLIC_DIR . "/img/news/";
        ...
        $postId = $postModel->insertNews($title, $content, $categoryId, $image);
...
$categories = $categoryModel->getAllNewsCategories();

render('admin/add_news', [
